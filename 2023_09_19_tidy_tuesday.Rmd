...
tt_caption <- paste0("Steven Turnbull #TidyTuesday 2023-09-19<span style='color:", bg_color, ";'>..</span><br>synergia.consulting")
...
```{r Visualize,fig.width=20,fig.height=20}
full_edge_list |>
  ggplot() +
  ...
  annotate(geom = "text", label = hadley$name,
           xend = hadley$x,yend = hadley$y,x = 16,y=hadley$y-0.2,
           colour=yellow,size=10) +
 geom_curve(aes(x = 16, y = hadley$y, xend = hadley$x+0.1, yend = hadley$y+0.1),
             arrow = arrow(length = unit(0.10, "cm")),curvature = 0.2,colour="#473678") +
...
ggsave(
  filename = paste0(tt_source,"_",Sys.Date(),".png"),width = 15,height=15,
  device = "png",dpi=600)
