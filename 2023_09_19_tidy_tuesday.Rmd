...
full_edge_list |>
  ...
  annotate(geom = "text", label = hadley$name,
           ...
           colour=yellow,size=8) +
 geom_curve(aes(x = 15, y = hadley$y, xend = hadley$x+0.1, yend = hadley$y+0.1),
             arrow = arrow(length = unit(0.7, "cm")),curvature = 0.2,colour="white") +
...
ggsave(
  filename = paste0(tt_source,"_",Sys.Date(),".png"),
